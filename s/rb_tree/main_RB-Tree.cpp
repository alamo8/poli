...
int main() 
{
 ...
 rbTree->deleteKey(12);
 rbTree->deleteKey(77);
 //rbTree->insertKey(7)->insertKey(3)->insertKey(18)->insertKey(10)->insertKey(22)->insertKey(8)->insertKey(11)->insertKey(26)->insertKey(2)->insertKey(6)->insertKey(13);
 //rbTree->deleteKey(18)->deleteKey(11)->deleteKey(3)->deleteKey(10)->deleteKey(22);
 rbTree->printInOrder();
 rbTree->printLevelOrder();
 Node<int>* tmp = rbTree->searchKey(177);
 if (tmp != NULL)
